...
def test_full_coverage_all_plays_in_chapters():
    ...
    for chapter in story.chapters:
        for play in chapter.plays:
            assert play.index not in covered_indices, f"Play {play.index} in multiple chapters"
...
def test_review_creates_boundary():
    ...
    timeline = [
        {"event_type": "pbp", "quarter": 1, "play_id": 0, "description": "Play 1"},
        {"event_type": "pbp", "quarter": 1, "play_id": 1, "description": "Instant replay review"},
...
def test_reset_cluster_collapse():
    ...
    config = ChapterizerConfig(collapse_reset_clusters=True, reset_cluster_window_plays=3)
...
def test_non_boundary_free_throws():
    ...
    timeline = [
        ...
        {"event_type": "pbp", "quarter": 1, "play_id": 2, "description": "Free throw made"},
...
def test_integration_full_game():
    ...
    # Q1
    for i in range(10):
        timeline.append({"event_type": "pbp", "quarter": 1, "play_id": len(timeline), "description": f"Q1 play {i}"})
    ...
    # More Q1
    for i in range(5):
        timeline.append({"event_type": "pbp", "quarter": 1, "play_id": len(timeline), "description": f"Q1 play {i+10}"})
    ...
    # Q3
    for i in range(10):
        timeline.append({"event_type": "pbp", "quarter": 3, "play_id": len(timeline), "description": f"Q3 play {i}"})
...
def test_config_customization():
    ...
    timeline = [
        {"event_type": "pbp", "quarter": 4, "play_id": 0, "description": "Play",
