...
class ChapterDebugLogger:
    ...
    def get_events_by_type(self, event_type: ChapterLogEventType) -> list[ChapterLogEvent]:
    ...
    def get_boundary_events_for_play(self, play_idx: int) -> list[ChapterLogEvent]:
        ...
        return [
            ...
            if hasattr(e, 'play_idx') and e.play_idx == play_idx
        ]
...
def trace_chapter_reason_codes(
    chapters: list[Any],
    debug_logger: ChapterDebugLogger
) -> dict[str, list[int]]:
