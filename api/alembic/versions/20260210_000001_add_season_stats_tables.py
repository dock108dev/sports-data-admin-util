...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_player_season_stats_league_season",
        "sports_player_season_stats",
        ["league_id", "season"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index("idx_player_season_stats_league_season", table_name="sports_player_season_stats")
    op.drop_table("sports_player_season_stats")
    op.drop_index("idx_team_season_stats_team_season", table_name="sports_team_season_stats")
    op.drop_table("sports_team_season_stats")
