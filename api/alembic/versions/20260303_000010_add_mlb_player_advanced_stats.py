"""Add mlb_player_advanced_stats table.

Revision ID: 20260303_mlb_player_adv
Revises: 20260303_mlb_adv_stats
...
revision = "20260303_mlb_player_adv"
down_revision = "20260303_mlb_adv_stats"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index("idx_mlb_player_advanced_game", "mlb_player_advanced_stats", ["game_id"])
    op.create_index("idx_mlb_player_advanced_team", "mlb_player_advanced_stats", ["team_id"])


def downgrade() -> None:
    op.drop_index("idx_mlb_player_advanced_team", table_name="mlb_player_advanced_stats")
    op.drop_index("idx_mlb_player_advanced_game", table_name="mlb_player_advanced_stats")
    op.drop_table("mlb_player_advanced_stats")
