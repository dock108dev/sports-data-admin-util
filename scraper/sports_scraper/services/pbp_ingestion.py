...
# -----------------------------------------------------------------------------
# NBA PBP ingestion via official NBA API (cdn.nba.com)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# NHL PBP ingestion via official NHL API (api-web.nhle.com)
# -----------------------------------------------------------------------------
...
def ingest_pbp_via_ncaab_api(
    ...
    *,
    ...
    from .ncaab_boxscore_ingestion import populate_ncaab_game_ids as _populate_ncaab_game_ids
