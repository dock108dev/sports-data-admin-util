"""NCAA Football scraper using sports-reference.com/cfb."""
...
class NCAAFSportsReferenceScraper(BaseSportsReferenceScraper):
    sport = "ncaaf"
    league_code = "NCAAF"
    base_url = "https://www.sports-reference.com/cfb/boxscores/"

    def _parse_team_row(self, row) -> tuple[TeamIdentity, int]:
        # NCAAF uses last td for score instead of class="right"
    ...
    def fetch_single_boxscore(self, source_game_key: str, game_date: date) -> NormalizedGame | None:
        ...
        boxscore_url = f"https://www.sports-reference.com/cfb/boxscores/{source_game_key}.html"
